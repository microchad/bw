...
<caption>An example of a 23-cell pattern applied to an Entropy Grid to create a Border Wallet. The user can use the EGG to calculate the Final Word (checksum).</caption>
